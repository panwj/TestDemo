...
public class MainFragment extends Fragment {
    ...
    @OnClick({R.id.record, R.id.stop, R.id.play, R.id.reset, R.id.wavePlay, R.id.recordPause, R.id.a})
    ...
    private void resolveRecord() {
        ...
        mRecorder = new MP3AudioRecorder(getActivity(), new File(filePath));

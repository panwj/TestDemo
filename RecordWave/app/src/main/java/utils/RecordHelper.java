...
public class RecordHelper {
    ...
    private static boolean shouldChangeAudioSetting(){
        String deviceName = utils.DeviceName.getDeviceName();
    ...
    public static void setDefaultRecordConfig(Context ctx) {
        ...
        // init value
        utils.SharedPreferencesUtil.put(ctx, utils.Utils.CURRENT_USE_SOURCE, phoneInfo.getmAudioSource());
        utils.SharedPreferencesUtil.put(ctx, utils.Utils.CURRENT_USE_FORMAT, phoneInfo.getmAudioFormat());

        // default value
        if (sdk_int <= 22) {
            utils.SharedPreferencesUtil.put(ctx, utils.Utils.DEVICE_DEFAULT_SUPPORT_RECORDER_SOURCE, MediaRecorder.AudioSource.VOICE_CALL);
            utils.SharedPreferencesUtil.put(ctx, utils.Utils.DEVICE_DEFAULT_SUPPORT_RECORDER_FORMAT, MediaRecorder.OutputFormat.THREE_GPP);
        } else {
            utils.SharedPreferencesUtil.put(ctx, utils.Utils.DEVICE_DEFAULT_SUPPORT_RECORDER_SOURCE, MediaRecorder.AudioSource.MIC);
            utils.SharedPreferencesUtil.put(ctx, utils.Utils.DEVICE_DEFAULT_SUPPORT_RECORDER_FORMAT, MediaRecorder.OutputFormat.MPEG_4);
        }

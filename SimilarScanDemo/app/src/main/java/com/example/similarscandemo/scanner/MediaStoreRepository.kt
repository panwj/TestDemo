...
import com.example.similarscandemo.util.int
import com.example.similarscandemo.util.long
...
class MediaStoreRepository(context: Context) {
    ...
    fun forEachMediaBatch(
        ...
        if (MediaPermissionHelper.canReadImages(appContext)) {
            /*
        ...
        if (MediaPermissionHelper.canReadVideos(appContext)) {
